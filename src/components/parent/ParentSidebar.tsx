...
import {
  FiHome, FiUsers, FiClipboard, FiBarChart2, FiCalendar, 
  FiMessageSquare, FiCheckSquare, FiBell, FiSettings, 
  FiChevronLeft, FiChevronRight, FiMenu, FiX, FiUser
} from 'react-icons/fi';
...
const ParentSidebar: React.FC<SidebarProps> = ({ isCollapsed, toggleSidebar, onMobileToggle }) => {
  ...
  const memoizedHandleMobileToggle = React.useCallback(() => {
