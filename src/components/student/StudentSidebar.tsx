...
import { FiBook, FiSettings, FiHome, FiChevronLeft, FiChevronRight,   FiCalendar, FiMenu, FiX,  FiLayers,  FiUser, FiFileText, FiVideo,  FiMessageSquare, FiClipboard, FiBell, FiBarChart2 } from 'react-icons/fi';
