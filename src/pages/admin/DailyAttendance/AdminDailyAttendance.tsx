	...
	return (
		<Container>
			<PageHeader
				...
				subtitle='Manage daily attendance records for all students'
			/>
			...
			<HeaderInfo>
				<InfoCard>
					...
					<InfoCardContent>
						...
						<InfoCardLabel>Total Levels</InfoCardLabel>
					</InfoCardContent>
				</InfoCard>
				...
				<InfoCard>
					...
					<InfoCardContent>
						...
						<InfoCardLabel>Total Classes</InfoCardLabel>
					</InfoCardContent>
				</InfoCard>
			...
			{loading ? (
				...
				<EmptyState>
					...
					<p>There are no levels available in the system.</p>
				</EmptyState>
			) : (
				<>
					<SearchContainer>
