...
const LevelSelect: React.FC = () => {
	...
	const { levels, isLoadingLevels, levelsError, fetchAdminLevels } = useSubmissionsStore()
	...
	const handleLevelClick = (levelId: string) => {
		navigate(`/admin/submissions/levels/${levelId}/classes`)
	}
	...
	return (
		<PageContainer>
			...
			<ContentContainer>
				<LevelGrid as={motion.div} variants={containerVariants} initial='hidden' animate='show'>
