...
const ClassSelect: React.FC = () => {
	...
	const { classes, levels, isLoadingClasses, classesError, fetchAdminLevelClasses } =
		useSubmissionsStore()

	// Fetch classes for the selected level
	useEffect(() => {
		if (levelId) {
			fetchAdminLevelClasses(levelId)
		}
	}, [levelId, fetchAdminLevelClasses])
	...
	const handleClassClick = (classId: string) => {
		navigate(`/admin/submissions/levels/${levelId}/classes/${classId}/students`)
	}
